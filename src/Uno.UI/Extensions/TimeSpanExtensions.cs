...
namespace Uno.UI.Extensions
{
    public static class TimeSpanExtensions
    {
		...
		public static TimeSpan RoundToPreviousMinuteInterval(this TimeSpan time, int interval)
		{
		...
		/// <param name="interval">minute interval</param>
		/// <returns>Rounded timespan</returns>
		public static TimeSpan RoundToNextMinuteInterval(this TimeSpan time, int interval)
		{
			if (interval > 0 && time != TimeSpan.Zero)
			{
		...
		/// <param name="interval">minute interval</param>
		/// <returns>Rounded timespan</returns>
		public static TimeSpan RoundToMinuteInterval(this TimeSpan time, int interval)
		{
			if (interval > 0 && time != TimeSpan.Zero)
			{
